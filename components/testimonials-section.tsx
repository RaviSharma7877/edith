...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Edith gives our finance and operations teams the same picture. Deals, invoices, collections, and reports finally stay connected.",
      name: "Aarav Mehta",
      company: "Founder, Studio Ledger",
      image:
    ...
    {
      quote:
        "The reconciliation workflow is exactly what we wanted: fast suggestions, clear review, and no loss of audit control.",
      name: "Sarah Chen",
      company: "Finance Lead, Northstar Works",
      image:
    ...
    {
      quote:
        "We can move from proposal to invoice to payment without rebuilding context in another tool. That is the daily win.",
      name: "Marcus Rodriguez",
      company: "Operations Director, Align Advisory",
      image:
