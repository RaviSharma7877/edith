        ...
        <div className="relative bg-white rounded-lg shadow-lg border border-[#e0dedb] overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 border-b border-[#e0dedb]">
            <div className="flex items-center gap-3">
              <div className="text-[#37322f] font-semibold">Edith</div>
          ...
          <div className="flex">
            ...
            <div className="w-48 bg-[#fbfaf9] border-r border-[#e0dedb] p-4">
              <nav className="space-y-2">
                ...
                {["Home", "Accounts", "Journals", "Invoices", "Payments", "Reports"].map((item) => (
            ...
            <div className="flex-1 p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-[#37322f]">Reconciliation</h2>
                <Button className="bg-[#37322f] hover:bg-[#37322f]/90 text-white text-sm">Import statement</Button>
              </div>
                ...
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className="grid grid-cols-6 gap-4 p-4 border-b border-[#e0dedb] text-sm">
                    ...
                    <div>
                      ...
                      >
                        {i % 3 === 0 ? "Reconciled" : i % 3 === 1 ? "Review" : "Draft"}
                      </span>
                    </div>
                    <div className="text-[#605a57]">Invoice payment</div>
                    <div className="font-medium">$3,862.32</div>
                    <div className="text-[#605a57]">1 Aug 2026</div>
                    <div className="text-[#605a57]">10 Aug 2026</div>
                  </div>
                ))}
              </div>
            </div>
